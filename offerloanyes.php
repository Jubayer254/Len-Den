  ...
  <div class="container-fluid">
    <div class="row">
      <div class="col-lg-8 col-md-12 col-sm-12 left2">
        <form action="offerloanyes2.php" method="POST">
          <h3 class="h3x">Offer Loan</h3>
          <div class="form-group padx">
            <input type="text" class="form-control form-control-lg" value="৳ <?php echo $amount ?>" disabled>
            <input type="hidden" name="amount" class="form-control form-control-lg" value="<?php echo $amount ?>">
          </div>

          <div class="form-group padx w-100">
            <input placeholder="Deadline" name="deadline" type="text" onfocus="(this.type = 'date')" id="date" class="form-control form-control-lg" required>
          </div>
          <div class="form-group padx">
            <input type="text" class="form-control form-control-lg" name="interest" placeholder="Interest Rate" required>
          </div>

          <div class="btn1 padx">
            <button type="submit" class="btn btn-warning custom-btn w-100">Offer</button>
          </div>
        </form>
      </div>
